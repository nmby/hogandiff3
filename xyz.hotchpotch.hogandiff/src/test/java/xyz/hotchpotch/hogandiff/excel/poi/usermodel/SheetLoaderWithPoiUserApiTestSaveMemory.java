...
class SheetLoaderWithPoiUserApiTestSaveMemory {
    ...
    static void beforeAll() throws URISyntaxException {
        test1_xls = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test1.xls").toURI()));
        test1_xlsb = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test1.xlsb").toURI()));
        test1_xlsm = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test1.xlsm").toURI()));
        test1_xlsx = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test1.xlsx").toURI()));
        ...
        test4_xls = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test4.xls").toURI()));
        test4_xlsx = BookInfo
                .of(Path.of(SheetLoaderWithPoiUserApiTestSaveMemory.class.getResource("Test4.xlsx").toURI()));
    }
