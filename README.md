...
「方眼Diff.exe」および「xyz.hotchpotch.hogandiff.*.jar」は nmby の著作物であり、MITライセンスのもと提供しています。  
...
- Apache POI
    ...
    - 詳細は[Apache POIのWebサイト](https://poi.apache.org/)および「方眼Diff-x.x.x-zzz\lib\poi-4.1.0\」フォルダ内の関連ファイルをご参照ください。
