...
class BookLoaderWithPoiUserApiTest {
    ...
    static void beforeAll() throws URISyntaxException {
        test1_xls = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test1.xls").toURI());
        test1_xlsb = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test1.xlsb").toURI());
        test1_xlsm = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test1.xlsm").toURI());
        test1_xlsx = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test1.xlsx").toURI());
        test2_xls = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test2_passwordAAA.xls").toURI());
        test2_xlsx = Path.of(BookLoaderWithPoiUserApiTest.class.getResource("Test2_passwordAAA.xlsx").toURI());
    }
    ...
    void testLoadSheetNames_例外系_チェック例外() {
        ...
        assertThrows(
                ...
                () -> testee.loadSheetNames(Path.of("X:\\dummy\\dummy.xlsx")));
